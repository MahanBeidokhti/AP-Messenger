...
public:
    ...
    QLabel *warning_firstname;
    QLabel *Label_lastname;
    QLineEdit *input_lastname;
    QLabel *warning_lastname;
...
""));
        ...
        warning_username = new QLabel(Signin_Box);
        warning_username->setObjectName(QString::fromUtf8("warning_username"));
        warning_username->setStyleSheet(QString::fromUtf8("color: rgb(170, 0, 0);"));

        formLayout->setWidget(2, QFormLayout::SpanningRole, warning_username);
        ...
        formLayout->setWidget(3, QFormLayout::LabelRole, Label_password__sign);
        ...
        formLayout->setWidget(4, QFormLayout::SpanningRole, input_password_sign);

        warning_password = new QLabel(Signin_Box);
        warning_password->setObjectName(QString::fromUtf8("warning_password"));
        warning_password->setStyleSheet(QString::fromUtf8("color: rgb(170, 0, 0);"));

        formLayout->setWidget(5, QFormLayout::SpanningRole, warning_password);

        Label_Fname = new QLabel(Signin_Box);
        Label_Fname->setObjectName(QString::fromUtf8("Label_Fname"));
        Label_Fname->setFont(font3);

        formLayout->setWidget(6, QFormLayout::LabelRole, Label_Fname);
        ...
        formLayout->setWidget(7, QFormLayout::SpanningRole, input_firstname);

        warning_firstname = new QLabel(Signin_Box);
        warning_firstname->setObjectName(QString::fromUtf8("warning_firstname"));
        warning_firstname->setStyleSheet(QString::fromUtf8("color: rgb(170, 0, 0);"));

        formLayout->setWidget(8, QFormLayout::SpanningRole, warning_firstname);
        ...
        formLayout->setWidget(9, QFormLayout::LabelRole, Label_lastname);
        ...
        formLayout->setWidget(10, QFormLayout::SpanningRole, input_lastname);

        warning_lastname = new QLabel(Signin_Box);
        warning_lastname->setObjectName(QString::fromUtf8("warning_lastname"));
        warning_lastname->setStyleSheet(QString::fromUtf8("color: rgb(170, 0, 0);"));

        formLayout->setWidget(11, QFormLayout::SpanningRole, warning_lastname);
        ...
        formLayout->setWidget(12, QFormLayout::LabelRole, Button_back_sign);

        bottom_sign = new QPushButton(Signin_Box);
        bottom_sign->setObjectName(QString::fromUtf8("bottom_sign"));
        bottom_sign->setFont(font);

        formLayout->setWidget(12, QFormLayout::FieldRole, bottom_sign);
...
""));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        warning_username->setText(QCoreApplication::translate("MainWindow", "invalid username!", nullptr));
        ...
        warning_password->setText(QCoreApplication::translate("MainWindow", "invalid password!", nullptr));
        ...
        warning_firstname->setText(QCoreApplication::translate("MainWindow", "First name warning...", nullptr));
        ...
        warning_lastname->setText(QCoreApplication::translate("MainWindow", "Last name warning...", nullptr));
